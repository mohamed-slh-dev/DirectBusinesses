...
class VendorBlogController extends Controller
{
    ...
    public function browse()
    {
        ...
        return view('vendors.blogs.browse',compact('blogs','categories','subcategories'));
    ...
    public function post()
    {
        ...
        return view('vendors.blogs.post', compact('categories', 'subcategories'));
    ...
    public function create(Request $request)
    {
        ...
        // back to browse
        return redirect()->route('vendor.blogs.browse');
    ...
    public function view($id)
    {
        ...
        return view('vendors.blogs.view',compact('blog', 'relatedBlogs'));
