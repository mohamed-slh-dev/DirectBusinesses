	...
	function rangeBySalerySlider(){
		jQuery("#tg-filterbysalary").slider({
			...
			slide: function( event, ui ) {
				jQuery( "#tg-salaryamount" ).val(ui.values[ 0 ] + " AED" + " - " + ui.values[ 1 ] + " AED");
			}
		});
		jQuery( "#tg-salaryamount" ).val(jQuery( "#tg-filterbysalary" ).slider( "values", 0 ) + " AED" + " - " + jQuery( "#tg-filterbysalary" ).slider( "values", 1 ) + " AED" );
	}
	rangeBySalerySlider();
	/* --------------------------------------
			GEO LOCATION SLIDER
