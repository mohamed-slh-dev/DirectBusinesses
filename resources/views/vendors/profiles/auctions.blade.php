                            ...
                            <table class="table custom-pr-table custom-pr-table-dash">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span>  {{$auction->auction->items->count()}} / {{$auction->items->where('price','!=', null)->count()}} Items Checked</span></td>

                                        @if ($auction->auction->status == 'canceled')
                                        ...
                                        @elseif($auction->auction->status == 'on going')
                                        ...
                                        @elseif($auction->auction->status == 'finished')
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('vendor.auctions.viewRequest', [$auction->auction->id]) }}"
