                                ...
                                @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <textarea class="form-control" name="desc"
                                                        placeholder="Description" rows="7">{{$user->desc}}</textarea>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group tg-inputwithicon tg-facebook">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{(!empty($user_social->where('platform','facebook')->first()->url) ? $user_social->where('platform','facebook')->first()->url : '')}}"
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group tg-inputwithicon tg-twitter">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{(!empty($user_social->where('platform','twitter')->first()->url) ? $user_social->where('platform','twitter')->first()->url : '')}}"
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group tg-inputwithicon tg-linkedin">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{(!empty($user_social->where('platform','linkedin')->first()->url) ? $user_social->where('platform','linkedin')->first()->url : '')}}"
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group tg-inputwithicon tg-skype">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{(!empty($user_social->where('platform','skype')->first()->url) ? $user_social->where('platform','skype')->first()->url : '')}}"
                                                            name="skype" placeholder="skype Link">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group tg-inputwithicon tg-googleplus">
                                                        ...
                                                        <input type="text"
                                                            value="{{(!empty($user_social->where('platform','googleplus')->first()->url) ? $user_social->where('platform','googleplus')->first()->url : '')}}"
                                                            class="form-control" name="googleplus" placeholder="google Plus Link">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group tg-inputwithicon tg-pinterestp">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{(!empty($user_social->where('platform','painterest')->first()->url) ? $user_social->where('platform','painterest')->first()->url : '')}}"
                                                            name="painterest" placeholder="pinterest Link">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tg-dashboard tg-dashboardmanageservices" style="margin: 40px 0px;">
                                        <div class="tg-dashboardhead">
                                            ...
                                            <a href="javascript:void(0);" class="tg-btnaddservices text-offwhite-f"
                                                data-toggle="modal" data-target=".tg-categoryModal"
                                    ...
                                    <div class="tg-dashboardbox tg-certificatesawards">
                                        <div class="tg-dashboardtitle">
                                            ...
                                            <a class="tg-btnaddnew text-offwhite-f" href="#" class=""
                                                data-toggle="modal" data-target=".tg-certificatesawardsModal"
                                                style="text-decoration: underline;">+ add
                                                new</a>
                                        </div>
                                    ...
                                    <div class="tg-companyfeaturebox" style="padding-top:35px;">
                                        <div class="tg-companyfeaturetitle">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <a href="{{ route('vendor.blogs.post') }}" class="tg-btnaddservices text-offwhite-f"
                                                        style="text-decoration: underline;">+
                                                        Add Blog</a>
                                                </div>
                                            </div>
                                ...
                                <div class="tg-upload">
                                    ...
                                    <div class="tg-box">
                                        <label class="tg-fileuploadlabel" for="tg-photogallery">
                                            <i class="lnr lnr-cloud-upload"></i>
                                            <span>Or Drag Your Files Here To Upload</span>
                                            <input id="tg-photogallery" class="tg-fileinput" type="file" name="certificate_doc">
                                        </label>
                                    </div>
                                    <!-- end image -->
