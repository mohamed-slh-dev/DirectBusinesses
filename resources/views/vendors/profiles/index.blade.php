                                                            ...
                                                            <div class="tg-reviewcontent">
                                                                <div class="tg-reviewhead">
                                                                    <div class="tg-reviewheading review-company-name">
                                                                        <h3><a href="{{ route('vendor.companies.profile', [$rate->reviewer->id]) }}">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <a href="{{ route('vendor.blogs.view', [$blog->id]) }}" class="blog-compact-item-container">
                                            <div class="blog-compact-item blog-custom-card border-all-radius">
                                                <img src="{{ asset('assets/uploads/blogs/'.$blog->img) }}" alt="" class="border-bothtop-radius" style="height: 170px; width: 100%; object-fit:contain">
