    ...
    <div class="tg-main-section tg-haslayout pr-layout">
        <div class="container">
            <div class="tg-appointmentsetting">
                ...
                <form class="tg-formbookappointment" method="post" action="{{ route('vendor.blogs.create') }}"
                                ...
                                <div class="row align-items-sm-end" style="margin-bottom: 30px;">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-4">
                                        <div class="blog-img-viewer">
                                            <img src="" alt="empty" id="blogcover"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="section-title" class="form-control"
                                                placeholder="Section Title" id="section-title">
                                        </div>
                                    </div>
