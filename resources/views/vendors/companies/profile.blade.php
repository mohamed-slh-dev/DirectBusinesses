        ...
        <div class="tg-detailpagehead">
            <figure>
                @if (empty($user->banner_img))
                    <img style="object-fit: cover; object-position: center;" src="{{ asset('assets/uploads/banner-imgs/default-header.png') }}"
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="tg-detailpageheadcontent">
                                    <div class="tg-companylogo"><img src="{{ asset('assets/uploads/profile-logos/'.$user->profile_img) }}"
                        ...
                        <div id="tg-content" class="tg-content">
                            ...
                            <div class="tg-companyfeatures">
                                                ...
                                                <div class="tg-feedbackbox review-content-wrapper"
                                                    ...
                                                    <div class="tg-contenthead">
                                                        <div class="tg-leftbox">
                                                            ...
                                                            <ul class="tg-matadata">
                                                                <li><a href="{{ route('vendor.companies.profile', [$rate->reviewer->id]) }}">{{$rate->reviewer->company_name}}</a></li>
                                ...
                                <div class="tg-companyfeaturebox tg-reviewformrating">
                                    <form class="tg-themeform tg-formleavefeedback" action="{{ route('vendor.companies.addreview') }}" method="post">
                                        @csrf
                                ...
                                <div class="tg-contactinfobox">
                                    ...
                                    <ul class="tg-socialicons">
                                        @if (!empty($user_social->where('platform','facebook')->first()->url))
                                            <li class="tg-facebook"><a href="https://{{$user_social->where('platform','facebook')->first()->url}}"><i class="fa fa-facebook"></i></a></li>    
                                        ...
                                        @if (!empty($user_social->where('platform','twitter')->first()->url))
                                            <li class="tg-twitter"><a href="https://{{$user_social->where('platform','twitter')->first()->url}}"><i class="fa fa-twitter"></i></a></li>
                                        ...
                                        @if (!empty($user_social->where('platform','linkedin')->first()->url))
                                            <li class="tg-linkedin"><a href="https://{{$user_social->where('platform','linkedin')->first()->url}}"><i class="fa fa-linkedin"></i></a></li>        
                                        ...
                                        @if (!empty($user_social->where('platform','skype')->first()->url))
                                            <li class="tg-skype"><a href="https://{{$user_social->where('platform','skype')->first()->url}}"><i class="fa fa-skype"></i></a></li>
                                        ...
                                        @if (!empty($user_social->where('platform','googleplus')->first()->url))
                                            <li class="tg-googleplus"><a href="https://{{$user_social->where('platform','googleplus')->first()->url}}"><i class="fa fa-google-plus"></i></a></li>
                                        ...
                                        @if (!empty($user_social->where('platform','painterest')->first()->url))
                                            <li class="tg-pinterestp"><a href="https://{{$user_social->where('platform','painterest')->first()->url}}"><i class="fa fa-pinterest-p"></i></a></li>
