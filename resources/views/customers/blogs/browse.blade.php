                    ...
                    <div class="tg-companyfeaturetitle pb-0">
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                ...
                                <form action="{{ route('customer.blogs.filterBlogs') }}" method="post">
                                @csrf
                            ...
                            <div class="col-3 text-right">
                                <a class="postblog-button" href="{{ route('customer.blogs.post') }}"
                        ...
                        <div class="col-sm-4 mb-5" style="border-radius: 5px; margin-bottom: 40px;">
                            ...
                            <a href="{{ route('customer.blogs.view', [$blog->id]) }}" class="blog-compact-item-container">
                                <div class="blog-compact-item blog-custom-card" style="border-radius: 5px;">
                                    ...
                                    {{-- image + tags --}}
                                    <img src="{{ asset('assets/uploads/blogs/'.$blog->img) }}" alt="" style="border-top-left-radius: 5px; border-top-right-radius: 5px; object-fit:contain; height: 250px; width: 100%;">
                                    <span class="blog-item-tag custom-blog-tag">
                        
                                        @foreach ($blog->tags as $tag)
                                            <span class="mr-2 mb-1" style="white-space: nowrap !important">{{ $tag->subcategory->name }}</span>
                                        @endforeach
                                    ...
                                    <div class="blog-compact-item-content custom-blog-content">
                                        <ul class="blog-post-tags">
                                            <li class="custom-blog-date"> {{ date('d M Y - h:i A', strtotime($blog->created_at)) }} </li>
                                        </ul>
