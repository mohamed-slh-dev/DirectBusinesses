...
<body class="tg-home tg-login custom-dark-bg pr-0" style="padding-right: 0px !important;">
        ...
        <header id="tg-header" class="tg-header tg-haslayout">
                                ...
                                <div class="col-xs-9 col-md-9 col-lg-10">
                                    <div class="scroll-left">
                                        ...
                                        <span>
                                            ...
                                            adipisicing elit. Eius, est!</span>
                                    </div>
                                ...
                                <div class="row align-items-center" style="height:50px;">
                                    <div class="col-5">
                                        ...
                                        <div class="tg-themedropdown tg-userdropdown">
                                            <a href="#" class="btn btn-none notif-bell" data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                            ...
                                            {{-- dropdown menu --}}
                                            <div class="tg-dropdownmenu tg-usermenu" aria-labelledby="tg-notification"
                                                ...
                                                {{-- <a href="#" class="d-block notif-link">
                                                    ...
                                                    <p class="notif-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto optio
                                                        in necessitatibus tempore excepturi earum laboriosam blanditiis. Eos?</p>
                                                </a> --}}
                                            </div>
            ...
            <div class="tg-navigationarea" style="padding: 8px 0px; background-color: white;">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <strong class="tg-logo"><a href="{{ route('customer.home') }}">
                                    <img src="{{ asset('assets/images/logo.png') }}" width="90" height="120" alt="image description"></a></strong>
                                    ...
                                    <div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
                                        <ul>
                                            ...
                                            <li style="padding-right:0px;">
                                                <a href="{{ route('customer.deals.browse') }}" class="see-opp-button">See Deals</a>
                                            </li>
                                            
                                            <li>
                                                <a class="see-opp-button-two" href="{{ route('customer.requirements.post') }}" style="margin-left:0px;">Post Requirements</a>
                                            </li>
                                ...
                                <div class="tg-useradminbox" style="width: 130px;">
                                    ...
                                    <div class="tg-themedropdown tg-userdropdown">
                                        <a href="#" id="tg-usermenu" class="tg-btndropdown" data-toggle="dropdown" aria-haspopup="true"
                                            ...
                                            <span id="nav-profile-button-customer">
    ...
    <script src="{{ asset('assets/prev-js/post-requirement.js') }}"></script>
    <script src="{{ asset('assets/prev-js/post-auction.js') }}"></script>
