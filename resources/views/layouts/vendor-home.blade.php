...
<body class="tg-home tg-login custom-dark-bg">
    ...
    <!-- script contain direct business card info -->
    <script>
        dbcards = [
    			{
    				'id': '# 128',
    				'company': 'Eishar Ltd.',
    				'logo': 'prev-images/demologo1.png',
    				'requirement': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Et assumenda delectus quisquam, veniam repudiandae tenetur autem explicabo, esse illum eaque! Quas',
    			},
    
    			{
    				'id': '# 140',
    				'company': 'TB Company',
    				'logo': 'prev-images/demologo4.png',
    				'requirement': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, expedita? Corrupti, harum libero! Expedita fugiat aperiam quos voluptatem modi!',
    			}
    		];
    		...
    		grcards = [
    			{
    				'id': '# 201',
    				'company': 'Sama Duabi Co.',
    				'logo': 'assets/prev-images/demologo2.jpg',
    				'requirement': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Et assumenda delectus quisquam, veniam repudiandae tenetur autem explicabo, esse illum eaque! Quas',
    			},
    
    			{
    				'id': '# 89',
    				'company': 'Lions Ltd.',
    				'logo': 'assets/prev-images/demologo6.jpg',
    				'requirement': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, expedita? Corrupti, harum libero! Expedita fugiat aperiam quos voluptatem modi!',
    			}
    		];
